...
import { p as parseURL, e as encodePath, k as decodePath, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, s as sanitizeStatusCode, o as getContext, $ as $fetch, q as defu, c as createError$1, r as executeAsync } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./dashboard-BjDs6Ru3.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import('./login-DA_zVSp3.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-KqGq-1Dg.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BZCgxa6P.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-pjo3-gPZ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BXSnG6NG.mjs'));
